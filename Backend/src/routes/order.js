...
const oRouter = express.oRouter();
const pool = require("../config/db");
const authMiddleware = require("../middleware/auth");

// Place an order
oRouter.post("/", authMiddleware, async (req, res) => {
...
oRouter.get("/", authMiddleware, async (req, res) => {
  const userId = req.user.id;
...
oRouter.get("/:id", authMiddleware, async (req, res) => {
...
oRouter.put("/:id", authMiddleware, async (req, res) => {
  const orderId = req.params.id;
